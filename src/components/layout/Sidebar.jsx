...
export default function Sidebar({
 ...
 <aside
  ...
  } z-40 min-h-screen h-[100dvh] flex flex-col bg-white dark:bg-slate-900 overflow-hidden`}
>
  {/* Conteúdo principal da sidebar (rolável) */}
  <div className="flex-1 overflow-y-auto px-3 py-4">
    <div className="space-y-6">
      ...
      <div className="hidden lg:grid grid-cols-1 gap-4 mb-6">
        ...
        {/* Outras estatísticas podem continuar aqui */}
      </div>
