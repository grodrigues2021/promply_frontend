...
>
  ...
  <div className="space-y-6 lg:pb-0 pb-24 lg:overflow-visible overflow-y-auto">
    <Card className="rounded-xl bg-white/90 dark:bg-slate-900/90 backdrop-blur-md shadow-[0_2px_10px_rgba(0,0,0,0.08)] dark:shadow-[0_2px_10px_rgba(0,0,0,0.4)] flex flex-col h-full border-0">
      ...
      <div className="grid grid-cols-3 gap-2 px-3 pb-2">
        <div className="flex items-center justify-center gap-1.5 bg-blue-100 text-blue-700 text-xs sm:text-sm px-2 py-1.5 rounded-full shadow-sm">
          <BookOpen className="w-4 h-4" />
          <span>{stats.total_prompts || 0}</span>
        </div>
        <div className="flex items-center justify-center gap-1.5 bg-purple-100 text-purple-700 text-xs sm:text-sm px-2 py-1.5 rounded-full shadow-sm">
          <Tag className="w-4 h-4" />
          <span>{stats.total_categories || 0}</span>
        </div>
        <div className="flex items-center justify-center gap-1.5 bg-pink-100 text-pink-700 text-xs sm:text-sm px-2 py-1.5 rounded-full shadow-sm">
  ...
  <div className="lg:hidden fixed bottom-0 left-0 w-[260px] bg-gradient-to-r from-purple-600 to-blue-600 text-white px-4 py-3 flex items-center justify-between shadow-inner rounded-t-xl">
