...
>
  ...
  {/* Rodapé fixo - somente no mobile */}
  <div className="lg:hidden fixed bottom-0 left-0 w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white px-4 py-3 flex items-center justify-between shadow-inner">
