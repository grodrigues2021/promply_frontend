...
>
  ...
  {/* Conteúdo rolável */}
  <div className="space-y-6 pb-20"> {/* adiciona espaço para não sobrepor o rodapé */}
    {/* ... todo o conteúdo existente da sidebar ... */}
  </div>

  {/* Rodapé fixo apenas dentro da sidebar mobile */}
<div className="lg:hidden absolute bottom-0 left-0 w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white px-4 py-3 flex items-center justify-between shadow-inner">
