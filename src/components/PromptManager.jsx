...
const deletePrompt = async (id) => {
 ...
 <aside
  className={`promply-sidebar relative flex flex-col h-[calc(100vh-80px)] ${
...
>
  ...
  <div className="flex-1 overflow-y-auto">
    <div className="space-y-6">
      {/* ... conteúdo existente dos cards de stats ... */}

      <Card className="rounded-xl bg-white/90 dark:bg-slate-900/90 backdrop-blur-md shadow-[0_2px_10px_rgba(0,0,0,0.08)] dark:shadow-[0_2px_10px_rgba(0,0,0,0.4)] flex flex-col border-0">
        ...
        <div className="mt-2 flex flex-wrap items-center gap-2 px-3 pb-3 lg:hidden">
