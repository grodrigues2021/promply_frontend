...
<aside
  className={`promply-sidebar relative flex flex-col ${
...
>
  ...
  <div className="flex-1 overflow-y-auto space-y-6 pb-24">
    <Card className="rounded-xl bg-white/90 dark:bg-slate-900/90 border-0 shadow-sm">
      ...
      {/* 🔹 Contadores logo abaixo do título */}
      <div className="grid grid-cols-3 gap-2 px-3 pb-2">
        <div className="flex items-center justify-center gap-1.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs sm:text-sm px-2 py-1.5 rounded-full shadow-sm">
          <BookOpen className="w-4 h-4" />
          <span>{stats.total_prompts || 0}</span>
        </div>
        <div className="flex items-center justify-center gap-1.5 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs sm:text-sm px-2 py-1.5 rounded-full shadow-sm">
          <Tag className="w-4 h-4" />
          <span>{stats.total_categories || 0}</span>
        </div>
        <div className="flex items-center justify-center gap-1.5 bg-pink-100 dark:bg-pink-900/30 text-pink-700 dark:text-pink-300 text-xs sm:text-sm px-2 py-1.5 rounded-full shadow-sm">
      ...
      {/* Lista de categorias */}
      <CardContent className="flex-1 space-y-2 pr-1">
        <Button
  ...
  {/* Rodapé fixo (mobile) */}
  <div className="lg:hidden flex items-center justify-between px-4 py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white shadow-inner rounded-b-xl">
